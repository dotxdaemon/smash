...
describe('App notebook shell', () => {
  ...
  it('renders the simplified dashboard loop', () => {
    ...
    expect(markup).toContain('data-topbar-tone="folio"')
    expect(markup).toContain('data-topbar-layout="rail"')
    expect(markup).toContain('data-section="training-console"')
    expect(markup).toContain('data-console-tone="folio"')
    expect(markup).toContain('data-console-layout="spread"')
    ...
    expect(markup).toContain('data-notes-tone="ledger"')
    expect(markup).toContain('data-log-link="inline"')
    expect(markup).toContain('data-nav-tone="bare"')
